    ...
    <footer>
        <section className="bg-[#E3F4FB] py-5">
          ...
          className="container rounded-3xl p-20  bg-slate-600 lg:bg-gradient-to-r from-slate-900 via-[#219dd6] to-blue-sapphire text-white">
            <div className="flex flex-col gap-5 lg:flex-row justify-around mb-10">
              {info.map((items, index) => (
                <div key={index} className="flex gap-5 px-2 lg:p-0 items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm font-semibold">{items.paragraph}</p>
                    </div>
                </div>
              ))}
            </div>
            <hr className="mx-5"/>
            <div className="flex flex-col lg:flex-row gap-5 lg:gap-0 justify-around px-10 items-center mb-10 lg:mb-5">
                <div>
                ...
                <div>
                    <h3 className="text-lg mb-2 font-semibold">Products</h3>
                    <ul className="font-medium text-base">
                        <li>Deposits</li>
                        <li>Transfers</li>
                        <li>Lending</li>
